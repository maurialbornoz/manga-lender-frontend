...
const LeaveAReview = ({submitReview} : LeaveAReviewProps) => {
        ...
        <div className="dropdown" style={{cursor: 'pointer'}}>
            ...
            {displayInput && 
                <form method='post' action='#'>
                    ...
                    <div>
                        <button type='button' className='btn btn-outline-primary mt-3' onClick={() => submitReview(starInput, reviewDescription)}>Submit Review</button>
                    </div>
                </form>
            }
        </div>
